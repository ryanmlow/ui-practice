    ...
    <div>
      ...
      <div className="mt-4 flex flex-col rounded-2xl bg-gray-200 p-8">
        <div className="flex flex-col py-4 lg:flex-row lg:items-center">
          <input
            className="rounded-xl border-4 bg-gray-600 py-8 pl-4 text-left placeholder:text-white placeholder:italic placeholder:opacity-50 lg:flex-10/12"
            type="text"
            placeholder="Add your task"
            value={taskInput}
            onChange={(e) => handleChange(e.target.value)}
          />
          <div className="lg:flex-2/12">
            <button
